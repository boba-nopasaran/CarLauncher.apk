...
.method constructor <init>(IILjava/net/Proxy;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/loc/bh;-><init>(IILjava/net/Proxy;Z)V
...
.method constructor <init>(IILjava/net/Proxy;Z)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/loc/bh;-><init>(IILjava/net/Proxy;ZLcom/loc/be$a;)V

    return-void
.end method

.method private constructor <init>(IILjava/net/Proxy;ZLcom/loc/be$a;)V
    .locals 4
    ...
    iput-wide v0, p0, Lcom/loc/bh;->h:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/loc/bh;->i:J

    new-instance v0, Lcom/loc/bh$1;

    invoke-direct {v0, p0}, Lcom/loc/bh$1;-><init>(Lcom/loc/bh;)V

    iput-object v0, p0, Lcom/loc/bh;->l:Ljavax/net/ssl/HostnameVerifier;

    iput p1, p0, Lcom/loc/bh;->b:I

    iput p2, p0, Lcom/loc/bh;->c:I

    iput-object p3, p0, Lcom/loc/bh;->f:Ljava/net/Proxy;

    iput-boolean p4, p0, Lcom/loc/bh;->d:Z

    iput-object v2, p0, Lcom/loc/bh;->k:Lcom/loc/be$a;
    ...
    iput-object v0, p0, Lcom/loc/bh;->j:Ljava/lang/String;
    :try_end_0
    ...
    iput-object v0, p0, Lcom/loc/bh;->e:Ljavax/net/ssl/SSLContext;
    :try_end_1
...
.method private a(Ljava/net/HttpURLConnection;)Lcom/loc/bk;
    .locals 9
    ...
    iget-object v3, p0, Lcom/loc/bh;->j:Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Lcom/loc/j;-><init>(Ljava/lang/String;)V
    ...
    :cond_7
    sget-object v0, Lcom/loc/bh;->a:Lcom/loc/bi;

    if-eqz v0, :cond_8

    sget-object v0, Lcom/loc/bh;->a:Lcom/loc/bi;

    invoke-interface {v0}, Lcom/loc/bi;->a()V
    ...
    iput-object v6, v0, Lcom/loc/bk;->a:[B

    iput-object v5, v0, Lcom/loc/bk;->b:Ljava/util/Map;

    iget-object v5, p0, Lcom/loc/bh;->j:Ljava/lang/String;

    iput-object v5, v0, Lcom/loc/bk;->c:Ljava/lang/String;
    :try_end_b
    ...
    invoke-static {v4, v5, v6}, Lcom/loc/t;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5}, Lcom/loc/t;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lcom/loc/bh;->k:Lcom/loc/be$a;

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/loc/bh;->k:Lcom/loc/be$a;

    iget-object v2, p0, Lcom/loc/bh;->f:Ljava/net/Proxy;

    invoke-interface {v0}, Lcom/loc/be$a;->a()Ljava/net/URLConnection;
    ...
    iget-object v0, p0, Lcom/loc/bh;->f:Ljava/net/Proxy;
    ...
    :cond_1
    :goto_0
    iget-boolean v1, p0, Lcom/loc/bh;->d:Z
    ...
    iget-object v2, p0, Lcom/loc/bh;->e:Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lcom/loc/bh;->l:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_2
    invoke-direct {p0, p2, v0}, Lcom/loc/bh;->a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
...
.method public static a(Lcom/loc/bi;)V
    .locals 0

    sput-object p0, Lcom/loc/bh;->a:Lcom/loc/bi;
...
.method private a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
    ...
    iget-object v1, p0, Lcom/loc/bh;->j:Ljava/lang/String;
...
# virtual methods
.method final a(Ljava/lang/String;Ljava/util/Map;[B)Lcom/loc/bk;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v0}, Lcom/loc/bh;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p0, v0}, Lcom/loc/bh;->a(Ljava/net/HttpURLConnection;)Lcom/loc/bk;
    :try_end_0
...
.method final a(J)V
    ...
    iput-wide p1, p0, Lcom/loc/bh;->i:J

    return-void
.end method

.method final a(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/loc/bg$a;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :try_start_0
    invoke-static {p3}, Lcom/loc/bh;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p2, v4}, Lcom/loc/bh;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    iget-wide v6, p0, Lcom/loc/bh;->i:J
    ...
    invoke-interface {p4}, Lcom/loc/bg$a;->c()V
    ...
    iget-wide v4, p0, Lcom/loc/bh;->h:J
    ...
    iget-wide v4, p0, Lcom/loc/bh;->i:J

    iget-wide v6, p0, Lcom/loc/bh;->h:J
    ...
    invoke-interface {p4, v2, v4, v5}, Lcom/loc/bg$a;->a([BJ)V
    ...
    iput-wide v4, p0, Lcom/loc/bh;->i:J
    :try_end_2
    ...
    invoke-interface {p4, v4, v6, v7}, Lcom/loc/bg$a;->a([BJ)V
    :try_end_6
    ...
    :cond_b
    :try_start_9
    invoke-interface {p4}, Lcom/loc/bg$a;->b()V
    :try_end_9
...
.method final b(J)V
    ...
    iput-wide p1, p0, Lcom/loc/bh;->h:J

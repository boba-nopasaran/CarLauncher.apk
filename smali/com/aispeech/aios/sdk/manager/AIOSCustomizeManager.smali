...
.method public disableNativeShortcutWakeup([Ljava/lang/String;)V
    ...
    const-string v3, "AIOSCustomizeManager"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "[AIOSCustomizeManager#disableNativeShortcutWakeup()] with: pinyins = ["
    ...
    invoke-static {v3, v5}, Lcom/aispeech/ailog/AILog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/aispeech/aios/sdk/utils/StringUtil;->isLegalPinyin(Ljava/lang/String;)Z
    ...
    const-string v5, "Pinyin is illegal : "
    ...
    const-string v5, "sdk.customize.native.shortcut.single.disable"
    ...
    invoke-virtual {v3, v5, v6}, Lcom/aispeech/aios/sdk/SDKNode;->publishSticky(Ljava/lang/String;[Ljava/lang/String;)V
...
.method public onInitialize()V
    ...
    invoke-virtual {v14, v15}, Lcom/aispeech/aios/common/bean/CustomizeTTSData;->getCustomizeTTS(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v15, "custom_cmd.xml"

    invoke-static {v14, v15}, Lcom/aispeech/aios/sdk/utils/PropertyUtil;->getDocument(Landroid/content/Context;Ljava/lang/String;)Lorg/w3c/dom/Document;
    ...
    iget-object v15, v0, Lcom/aispeech/aios/sdk/manager/AIOSCustomizeManager;->customizeCommandList:Ljava/util/List;

    new-instance v16, Lcom/aispeech/aios/sdk/bean/Command;
...
.method public regCommands(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/aispeech/aios/sdk/manager/AIOSCustomizeManager;->customizeCommandList:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/aispeech/aios/sdk/manager/AIOSCustomizeManager;->customizeCommandList:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcom/aispeech/aios/sdk/manager/AIOSCustomizeManager;->registerCommands(Ljava/util/List;)V
...
.method public registerShortcutWakeups(Ljava/util/List;)V
    ...
    const-string v7, "AIOSCustomizeManager"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "[AIOSCustomizeManager#registerShortcutWakeups()] with: shortcutWakeups = ["
    ...
    check-cast v5, Lcom/aispeech/aios/sdk/bean/ShortcutWakeup;

    if-eqz v5, :cond_0

    :try_start_0
    invoke-virtual {v5}, Lcom/aispeech/aios/sdk/bean/ShortcutWakeup;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v5}, Lcom/aispeech/aios/sdk/bean/ShortcutWakeup;->getPinyin()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v5}, Lcom/aispeech/aios/sdk/bean/ShortcutWakeup;->getThreshold()F
    ...
    const-string v8, "sdk.customize.shortcut.wakeup.customize"
...
.method public setMajorWakeup(Ljava/util/List;)V
    ...
    const-string v3, "[AIOSCustomizeManager#setMajorWakeup()] with: wakeupList = ["
    ...
    check-cast v0, Lcom/aispeech/aios/common/bean/MajorWakeup;

    iget-object v2, v0, Lcom/aispeech/aios/common/bean/MajorWakeup;->majorWakeupPinyin:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/aispeech/aios/common/bean/MajorWakeup;->majorWakeupPinyin:Ljava/lang/String;

...
.method public postMusicSearchResult(Ljava/util/List;I)V
    ...
    const-string v4, "AIOSMusicManager"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "[AIOSMusicManager#postMusicSearchResult()] with: musics = ["
    ...
    check-cast v2, Lcom/aispeech/aios/sdk/bean/Music;

    invoke-virtual {v2}, Lcom/aispeech/aios/sdk/bean/Music;->toJson()Lorg/json/JSONObject;
    ...
    :cond_1
    :try_start_1
    iget-object v4, p0, Lcom/aispeech/aios/sdk/manager/AIOSMusicManager;->searchKeys:Ljava/util/List;
    ...
    check-cast v4, Lcom/aispeech/aios/sdk/bean/SearchMusic;

    invoke-virtual {v4}, Lcom/aispeech/aios/sdk/bean/SearchMusic;->toJson()Lorg/json/JSONObject;
    ...
    const-string v5, "sdk.music.songs.search.result"
    ...
    invoke-virtual {v4, v5, v6}, Lcom/aispeech/aios/sdk/SDKNode;->publish(Ljava/lang/String;[Ljava/lang/String;)V
    :try_end_1
...
.method public syncLocalMusicList(Ljava/util/List;)V
    ...
    const-string v6, "[AIOSMusicManager#syncLocalMusicList()] with: list = ["
    ...
    check-cast v3, Lcom/aispeech/aios/sdk/bean/LocalMusic;

    invoke-virtual {v3}, Lcom/aispeech/aios/sdk/bean/LocalMusic;->toJSONObject()Lorg/json/JSONObject;
    ...
    invoke-static {v4, v5}, Lcom/aispeech/ailog/AILog;->json(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Lcom/aispeech/aios/sdk/SDKNode;->getInstance()Lcom/aispeech/aios/sdk/SDKNode;

    move-result-object v4

    const-string v5, "asset.songs"
    ...
    invoke-virtual {v4, v5, v6}, Lcom/aispeech/aios/sdk/SDKNode;->publishSticky(Ljava/lang/String;[Ljava/lang/String;)V
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_0
